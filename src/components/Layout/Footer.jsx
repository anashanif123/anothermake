        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-black leading-tight">
              Stay in the <span className="text-gray-600">Sillage</span>
            </h2>
            
            <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              Get early access to new perfumes, exclusive offers, and scent stories. 
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <p className="text-gray-300 mb-8 leading-relaxed text-lg">
                  Curated niche and designer fragrances. Discover your signature scent across eau de parfum, extrait, and colognes.
                </p>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <span className="font-medium">hello@aromahaus.com</span>
                  </motion.div>
                  ...
                  >
                    ...
                    <span className="font-medium">+1 (555) SCENT-01</span>
                  </motion.div>
                  ...
                  >
                    ...
                    <span className="font-medium">AromaHaus Boutique, New York, NY 10001</span>
                  </motion.div>
                </div>
              </motion.div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            >
              <div className="flex items-center gap-2">
                <span>© {currentYear} AromaHaus. All rights reserved.</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold text-white">AromaHaus</span>
            </div>
            ...
            >
              Elevating your scent wardrobe, one bottle at a time. Fine fragrances for every mood.
            </motion.p>
