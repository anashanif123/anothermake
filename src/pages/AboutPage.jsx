        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Founded in 2020, AromaHaus curates rare niche and beloved designer fragrances. 
              We believe great perfume can transform not just your style, but your presence.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                To help you discover a signature scent you truly love—through authentic bottles, 
                transparent notes, and concierge support.
              </p>
            ...
            >
              <div className="aspect-square bg-gradient-to-br from-gray-200 to-gray-300 rounded-3xl overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=1200&q=70"
                  alt="Our Mission"
          ...
          >
            <h2 className="text-4xl font-bold text-black mb-6">
              Meet Our Team
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  The passionate people behind AromaHaus
                </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Explore our collection and discover a fragrance that matches your mood
            </p>
            <motion.button
